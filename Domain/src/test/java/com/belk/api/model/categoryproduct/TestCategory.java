...
public class TestCategory extends TestCase {
	...
	/**
	 * Test method to test the method that set the List of products
	 * 
	 */
	...
	public final void testSetProducts() {
		...
		final Category category = new Category();
		final List<ProductSearch> productsearchList = new ArrayList<ProductSearch>();
		category.setProducts(productsearchList);
		assertTrue(category.getProducts() == productsearchList);

	}

	/**
	 * Test method to test the method that return the List of products
	 * 
	 */
